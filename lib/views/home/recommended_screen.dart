...
//         children: [
//           ListTile(
//             leading: SizedBox(height: 40, width: 40, child: Image.network(widget.dish['image'])),
//             title: Text(widget.dish['title'],style: TextStyle(fontWeight: FontWeight.bold),),
//             trailing: IconButton(
...
//                   },
//                   child: Text('Add Item | ₹${getPrice()}',style: TextStyle(color: Colors.white),),
//                 ),
//               ],
//             ),
//           ),
